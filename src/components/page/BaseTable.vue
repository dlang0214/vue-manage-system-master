<template>
    <div class="table">
        ...
        <el-table :data="tableData" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="countNumber" label="总盘点数" sortable width="120">
            </el-table-column>
            <el-table-column prop="countUserNo" label="总人数" sortable width="120">
            </el-table-column>
        ...
        <div class="schart">
            ...
            <schart canvasId="bar" width="500" height="400" :data="chartData" type="bar" :options="options1"></schart>
        </div>
    ...
    export default {
        ...
        methods: {
            ...
            getchuData(){//获取初盘数据
                ...
                self.chartData=[];
                self.url = 'http://appinter.sunwoda.com/common/PdaAssetUser/PdaNumberYear.json?year='+year+'&isFinance=1';
